...
def control_kwad(msg, args):
	...
	# Now we are eligible to construct the state vector using new states, previously stored states and time step
	...
	fUpdated = LQR(locationObj.x, locationObj.y, locationObj.z, roll, pitch, yaw, f)
